  ...
  return (
    <div className="flex gap-4">
      ...
      <div className="">
        ...
        <div className="text-[#797977] text-sm flex items-center gap-2">
            ...
            <div className="flex items-center">
              {rate.properties?.color && (
                <>
                  <SelectColorItem
                    size="0.8rem"
                    color={rate.properties?.color.colorValue}
                    colorName={rate.properties?.color.colorName}
                  ></SelectColorItem>
                  <p className="ml-2">{rate.properties?.color.colorName}</p>
                </>
              )}
