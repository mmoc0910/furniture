        ...
        <div className="w-full col-span-10 lg:col-span-7">
          ...
          <div className="md:py-3 font-semibold bg-[#bdcccb47] rounded-lg px-2 md:px-0">
            <div className="grid grid-cols-12 gap-[10px] font-bold py-2 text-lg md:text-xl">
              <div className="col-span-12 md:pl-3 md:col-span-7">
                Tên Sản phẩm
              </div>
              <div className="hidden col-span-1 md:block">SL</div>
              <div className="hidden col-span-2 md:block">Giá</div>
              <div className="hidden col-span-2 md:block md:line-clamp-1 md:pr-2">
                Thành tiền
              </div>
            </div>
            {listProducts.map((item) => (
              <div
                ...
                key={uuidv4()}
              >
                <div className="col-span-3 md:col-span-2 md:px-3">
                ...
                <div className="flex flex-col justify-center col-span-9 gap-1 md:col-span-5">
                  <Link
                    className="md:text-lg line-clamp-1"
                    title={item.productInfo.productName}
                    to={`./shop/${item.productInfo.slug}`}
                  >
                  ...
                  <div className="flex items-center">
                    ...
                    {item.properties.color && (
                      <div className="flex items-center gap-2">
                        ...
                        <p>{item.properties.color.colorValue}</p>
                      </div>
                    )}
