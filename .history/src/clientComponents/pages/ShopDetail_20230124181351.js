  ...
  return (
    <div className="flex gap-4">
      {user?.photoURL ? (
        ...
        <div className="flex items-center justify-center w-11 h-11 overflow-hidden bg-black rounded-full uppercase font-extrabold cursor-pointer text-xl leading-none text-[#e53637]">
