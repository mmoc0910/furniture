  ...
  return (
    <>
      ...
      <div className="container mb-24">
        <div className="flex items-center justify-center gap-x-28 font-bold text-[#b7b7b7] text-xl border-b border-solid border-[#e4e4e4]">
          <div
            className={`pb-5 relative cursor-pointer ${
              state === 0
                ? "text-black after:absolute after:w-[120%] after:h-[2px] after:bg-[#e53637] after:bottom-0 after:left-0 after:rounded-full after:translate-y-1/2"
                : ""
            }`}
            onClick={() => setState(0)}
          >
...
const DetailedOverview = ({ detailedOverview }) => {
  return (
    <>
      <div className="max-w-[90%] mx-auto max-h-[300px] overflow-hidden">
