...
const ReviewItem = ({ rate }) => {
  ...
  return (
    <div className="flex gap-4">
      {user?.photoURL ? (
        <img src={user?.photoURL} alt="" className="rounded-full w-11 h-11" />
      ) : (
        <div className="flex items-center justify-center w-11 h-11 overflow-hidden bg-black rounded-full uppercase font-extrabold cursor-pointer text-2xl leading-none text-[#e53637]">
      ...
      <div className="">
        ...
        <div className="text-[#797977] text-sm items-center gap-2">
