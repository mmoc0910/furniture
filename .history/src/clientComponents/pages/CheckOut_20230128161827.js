        ...
        <div className="w-full col-span-10 lg:col-span-7">
          ...
          <div className="py-3 font-semibold bg-[#bdcccb47] rounded-lg px-1">
            <div className="grid grid-cols-12 gap-[10px] font-bold py-2 text-xl">
              <div className="col-span-7 pl-3">Tên Sản phẩm</div>
              <div className="hidden col-span-1 md:block">SL</div>
              <div className="hidden col-span-2 md:block">Giá</div>
              <div className="col-span-2 line-clamp-1">Thành tiền</div>
            </div>
            {listProducts.map((item) => (
              <div className="grid grid-cols-12 gap-[10px] py-3" key={uuidv4()}>
                ...
                <div className="items-center hidden col-span-1 md:block">
                  {item.qty}
                </div>
                <div className="items-center hidden col-span-2 md:block">
