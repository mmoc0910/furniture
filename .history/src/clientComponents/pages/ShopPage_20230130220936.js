...
const ShopPage = () => {
  ...
  return (
    <>
      ...
      <div className="container grid gap-10 pt-24 pb-16 sm:grid-cols-1 lg:grid-cols-4">
      ...
      <div className="flex justify-center col-start-1 col-end-1 pb-24">
        <p className="px-3 py-1 border border-black rounded-lg cursor-pointer select-none">
          Xem thêm
        </p>
      </div>
    </>
