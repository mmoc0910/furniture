...
const CheckOut = () => {
  ...
  const {
    ...
    defaultValues: {
      ...
      district: {
        ...
        to_district_id: user?.address?.district?.to_district_name,
      },
      ward: {
        ...
        try {
          const fee = await axios({
            ...
            data: {
              ...
              height: handleCheckout(listProducts).totalHeight,
              length: handleCheckout(listProducts).totalLong,
              weight: handleCheckout(listProducts).totalWeight,
              width: handleCheckout(listProducts).totalWidth,
              insurance_value: handleCheckout(listProducts).totalPrice,
              coupon: null,
            },
          });
    ...
    try {
      ...
      listProducts.map((item) =>
        items.push({
          ...
          weight: item.productInfo.transpostInfo.weight,
        })
      );
      // console.log(items);
      const previewOrder = await axios({
        ...
        data: {
          ...
          cod_amount: handleCheckout(listProducts).totalPrice,
          weight: handleCheckout(listProducts).totalWeight,
          length: handleCheckout(listProducts).totalLong,
          width: handleCheckout(listProducts).totalWidth,
          height: handleCheckout(listProducts).totalHeight,
  ...
  return (
    <>
      ...
      <form
        className="container grid grid-cols-10 pb-40 pt-14 gap-[50px]"
        onSubmit={handleSubmit(onSubmit)}
      >
        <div className="w-full col-span-7">
          <div className="">
            <h3 className="mb-5 text-2xl font-bold">Sản phẩm</h3>
            <div className="py-3 font-semibold bg-[#bdcccb47] rounded-lg px-1">
              <div className="grid grid-cols-12 gap-[10px] font-bold py-2 text-xl">
                <div className="flex col-span-7 pl-3">Tên Sản phẩm</div>
                <div className="flex col-span-1">SL</div>
                <div className="flex col-span-2">Giá</div>
                <div className="flex col-span-2 line-clamp-1">Thành tiền</div>
              </div>
              {listProducts.map((item) => (
                <div
                  className="grid grid-cols-12 gap-[10px] py-3"
                  key={uuidv4()}
                >
                  ...
                  <div className="flex flex-col justify-center col-span-5 gap-1">
                    <Link className="text-lg line-clamp-1">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {Object.keys(item.properties).map(
                        (prop) =>
                          prop !== "color" && (
                            <p
                              className="px-1 text-sm border border-black border-solid rounded-lg"
                              key={uuidv4()}
                            >
                  ...
                  <div className="flex items-center col-span-1">{item.qty}</div>
              ...
              {/* <div className="grid grid-cols-12 gap-[10px] py-3">
                <div className="col-span-2 px-3">
                  <div className="w-full h-0 pb-[100%] relative">
                    <img
                ...
                <div className="flex flex-col justify-center col-span-5 gap-1">
                  ...
                  <div className="flex items-center gap-3">
                    <SelectColorItem
                      ...
                      color={"#bdcccb"}
                    ></SelectColorItem>
                    <p className="px-1 text-sm border border-black border-solid rounded-lg">
                      Zise To
                    </p>
                  </div>
                </div>
        ...
        <div className="w-full col-span-3">
          <div className="h-full">
            <div className="flex items-center justify-between mb-5">
              ...
              <Button
                type="submit"
                className="px-2 py-1 font-semibold text-white rounded-lg bg-[#4d7a94]"
              >
                Mua hàng
              </Button>
            </div>
