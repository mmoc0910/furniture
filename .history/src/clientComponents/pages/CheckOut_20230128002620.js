...
const CheckOut = () => {
  ...
  return (
    <>
      ...
      >
        <div className="w-full xl:col-span-7 col-span-10">
          <div className="">
            <div className="mb-5 flex items-center justify-between">
              <h3 className=" text-2xl font-bold">Sản phẩm</h3>
              {/* <Button
                type="submit"
                className="px-2 py-1 font-semibold text-white rounded-lg bg-[#4d7a94] xl:hidden"
              >
                Mua hàng
              </Button> */}
            </div>
          ...
          <div className="py-3 font-semibold bg-[#bdcccb47] rounded-lg px-1">
            ...
            {listProducts.map((item) => (
              <div className="grid grid-cols-12 gap-[10px] py-3" key={uuidv4()}>
        ...
        <div className="w-full col-span-10 xl:col-span-3">
          <div className="h-full">
            <div className="flex items-center justify-between mb-5">
              <h3 className="text-2xl font-bold">Thanh toán</h3>
              <Button
                type="submit"
                className="px-2 py-1 font-semibold text-white rounded-lg bg-[#4d7a94] block"
              >
                Mua hàng
              </Button>
            </div>
