    ...
    >
      ...
      <div className="mt-5">
        <div className="relative mb-1">
          <h6
            className={`text-[17px] font-semibold line-clamp-2 transition-all duration-200 ${
          ...
          <Link
            ...
            className={`capitalize cursor-pointer align-middle text-[#e53637] text-[17px] font-bold absolute transition-all duration-200 left-0 ${
              show
