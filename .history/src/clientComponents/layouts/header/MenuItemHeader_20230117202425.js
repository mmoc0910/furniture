    ...
    <>
      ...
      >
        <NavLink
          ...
          to={url}
          className={({ isActive }) =>
            `md:text-lg font-semibold relative md:after:absolute after:hidden md:after:block after:h-[3px] after:bg-[#e53637] after:top-full hover:after:w-full hover:after:left-0 after:transition-all after:duration-500 uppercase ${
              isActive
