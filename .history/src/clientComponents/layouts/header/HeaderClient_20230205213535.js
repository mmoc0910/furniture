    ...
    <div className="fixed z-50 w-16 h-16 right-10 bottom-10">
      <div className="absolute w-[350px] h-[450px] bg-white shadow-chat rounded-lg bottom-8 right-20">
        <div className="flex flex-col justify-between w-full h-full px-5 overflow-hidden">
          ...
          <div className="max-h-[90%%] h-full overflow-scroll scroll-hidden">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem,
            esse minima provident quos odit aut. Minus, quisquam nulla veniam
            eum ea fugit vel, autem eaque ipsam cum temporibus blanditiis velit
            quaerat odit libero totam sunt similique! Impedit, illum! Eaque,
            numquam! Maxime, atque? Repellendus explicabo ipsa deserunt
            praesentium! Eum veritatis fuga quibusdam saepe ipsam labore
            aspernatur rerum dolorem ducimus voluptate illo praesentium
            reprehenderit porro accusamus minus excepturi architecto animi,
            dolores nemo obcaecati recusandae? Doloremque in nihil animi? Quasi
            placeat similique ea tenetur iure expedita? Quidem laborum
            recusandae quia dolor totam blanditiis adipisci provident aperiam, a
            pariatur explicabo corrupti! Ex non dicta aliquid maxime porro
            sapiente, dolor rerum recusandae repellat ducimus laborum, et ipsum
            quas, reprehenderit suscipit obcaecati optio? Ea, itaque corrupti
            optio cum quos aperiam laboriosam iste harum fuga, sed molestiae a
            saepe ullam tenetur ducimus eius hic tempore aliquid voluptas
            beatae? Doloribus dignissimos aut eum sapiente quas beatae veniam
            iusto?
          </div>
          <div className="py-3">
            <form
              ...
              // }}
            >
              <input className="px-3 py-1 bg-[#efefef] rounded-full outline-none max-w-[77%] w-full" />
              <label htmlFor="image">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
