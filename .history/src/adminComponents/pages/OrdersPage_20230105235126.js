            ...
            <Box className="h-full col-span-5 overflow-x-hidden overflow-y-scroll space-y-7 scroll-hidden">
              <div className="">
                {order?.cancellationReason?.seller && (
                  <div className="mb-5 text-[#ed7976] font-semibold text-lg">
                    Lý do hủy đơn bên người bán:{" "}
                    {order?.cancellationReason?.seller}
                  </div>
                )}
                {!order?.cancellationReason?.seller && (
                ...
                <div className="flex items-center justify-between mb-5">
                  ...
                  {order?.status === 0 && !order?.cancellationReason.seller && (
                    <div className="flex items-center gap-5">
                      <Button
                          ...
                          try {
                            const createOrder = await axios({
                              ...
                              data: {
                                ...
                                cod_amount: handleCheckout(order.products)
                                  .totalPrice,
                                weight: handleCheckout(order.products)
                                  .totalWeight,
                                length: handleCheckout(order.products)
                                  .totalLong,
                                width: handleCheckout(order.products)
                                  .totalWidth,
                                height: handleCheckout(order.products)
                                  .totalHeight,
                                items,
                              },
                            });
