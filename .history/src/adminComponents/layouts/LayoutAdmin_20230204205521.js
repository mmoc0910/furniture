...
const ChatBox = () => {
  return (
    <div className="rounded-lg shadow-chat w-[550px] h-[450px] bg-white absolute bottom-0 left-16 z-50 cursor-default grid grid-cols-5">
      <div className="col-span-2 border-r border-[#e4e4e4] py-3 px-3">
        <p className="pb-5 text-xl font-bold">Chats</p>
        <div className="w-full">
          <div className="flex">
            <img
              ...
              alt=""
              className="w-10 h-10 mr-3 rounded-full grow-0 shrink-0"
            />
            <div className="">
