  ...
  return (
    <>
      ...
      <div className="h-full px-3">
        ...
        <div className="px-3 leading-tight py-1 bg-[#d7d7d6] rounded-lg text-black w-3/4 mt-5">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur,
          id.
        </div>
        <div className="px-3 leading-tight py-1 bg-[#d7d7d6] rounded-lg text-black max-w-[75%] w-max mt-5">
          Lorem, ipsum dolor.
        </div>
