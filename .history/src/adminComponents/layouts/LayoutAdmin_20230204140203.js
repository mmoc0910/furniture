...
const ChatIcon = () => {
  ...
  return (
    <div
      className={`flex mb-10 items-center justify-center w-10 h-10 rounded-lg cursor-pointer relative transition-all duration-150 ${
...
const ChatBox = () => {
  return (
    <div className="rounded-lg shadow-chat w-[300px] h-[450px] bg-white absolute -bottom-10 left-16 z-50 cursor-default">
      <div className="flex items-center w-full px-5 py-3 text-black">
        <p className="font-semibold text-[#32776b]">mmoc09@</p>
