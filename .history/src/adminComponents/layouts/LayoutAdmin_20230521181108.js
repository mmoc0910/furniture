          ...
          <div className="flex items-center justify-between pb-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="">
                ...
                <p className="text-[#32776b] decoration-[#32776b] underline cursor-pointer font-semibold">
                  Logout
                </p>
              </div>
            </div>
...
const ChatIcon = () => {
  ...
  return (
    <div className="relative">
      {state && <ChatBox onClick={() => setState(false)} />}
      <div
  ...
  return (
    <div className="rounded-lg shadow-chat w-[700px] h-[500px] bg-white absolute bottom-0 left-16 z-50 cursor-default grid grid-cols-7">
      ...
      <div className="flex flex-col justify-between col-span-4 overflow-hidden">
        <Chat user={user} onClick={() => onClick()} />
      </div>
    </div>
  );
};
