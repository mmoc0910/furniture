...
const ChatBox = () => {
  return (
    <div className="rounded-lg shadow-chat w-[300px] h-[450px] bg-white absolute -bottom-10 left-16 z-50">
      <div className="flex items-center w-full px-5 py-2 text-black">
        <p className="text-lg font-semibold">mmoc09@</p>
      </div>
    </div>
  );
};
