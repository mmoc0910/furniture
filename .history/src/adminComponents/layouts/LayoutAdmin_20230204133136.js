...
const ChatIcon = () => {
  ...
  return (
    <div
      className={`flex items-center justify-center w-10 h-10 rounded-lg cursor-pointer relative transition-all duration-150 ${
...
const ChatBox = () => {
  return (
    <div className="rounded-lg shadow-2xl w-[300px] h-[450px] bg-[#dce4e6] absolute bottom-0 right-10"></div>
  );
};
