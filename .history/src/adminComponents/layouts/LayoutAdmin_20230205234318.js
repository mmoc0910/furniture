      ...
      <div className="px-5 py-3">
        ...
        >
          <div className=" max-w-[80%] w-full">
            <div className="bg-[#efefef] w-full px-3 py-2 rounded-tl-2xl rounded-tr-2xl">
              <img
                ...
                alt=""
                className="w-20 h-20 rou-lg"
              />
            </div>
            <input
              className="px-3 py-1 bg-[#efefef] outline-none w-full rounded-bl-2xl rounded-br-2xl"
              ref={colRef}
            />
          </div>
