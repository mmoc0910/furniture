...
const ChatBox = () => {
  return (
    <div className="rounded-lg shadow-chat w-[550px] h-[450px] bg-white absolute bottom-0 left-16 z-50 cursor-default grid grid-cols-5">
      <div className="col-span-2 border-r border-[#e4e4e4] py-3 overflow-hidden">
        <p className="px-3 pb-5 text-xl font-bold">Chats</p>
        <input className="px-3 py-1 bg-[#efefef] rounded-full outline-none w-full mx-3" />
      ...
      <div className="flex flex-col justify-between col-span-3">
        <div className="flex items-center w-full px-5 py-3 text-black">
        ...
        <div className="px-5 py-3">
          <form className="flex items-center justify-between w-full">
            <input className="px-3 py-1 bg-[#efefef] rounded-full outline-none max-w-[80%]" />
            <label htmlFor="image">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
...
const UserChat = () => {
  return (
    <div className="flex px-3 py-2 hover:bg-[#eeeeee]">
      <img
        src="https://images.unsplash.com/photo-1675453028146-aec78542716e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwzfHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60"
        alt=""
