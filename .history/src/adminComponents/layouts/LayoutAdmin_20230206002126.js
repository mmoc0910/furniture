          ...
          <div className=" max-w-[80%] w-full">
            {images.length > 0 && (
              <div className="bg-[#efefef] w-full px-3 pt-3 pb-1 rounded-tl-2xl rounded-tr-2xl flex items-center gap-2">
                {[...images].splice(0, 4).map((img) => (
                  <div className="relative rounded-lg w-14 h-14" key={uuidv4()}>
                    <div className="absolute flex items-center justify-center w-5 h-5 bg-white rounded-full cursor-pointer -top-1 -right-1">
                      <span>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 20 20"
