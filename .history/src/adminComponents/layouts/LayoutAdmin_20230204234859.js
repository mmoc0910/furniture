  ...
  return (
    <>
      ...
      <div className="h-full px-3">
        ...
        <div className="px-3 leading-tight py-1 bg-[#d7d7d6] rounded-lg text-black max-w-[75%] w-max mt-2">
          Lorem, ipsum dolor.
        </div>
        <div className="px-3 leading-tight py-1 bg-[#32776b] rounded-lg text-white w-3/4 float-right">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur,
          id.
        </div>
      </div>
