      ...
      <div className="px-5 py-3">
        ...
        >
          <div className=" max-w-[80%] w-full">
            <div className="bg-[#efefef] w-full px-3 py-2 rounded-tl-lg rounded-tr-lg"></div>
            <input
              className="px-3 py-1 bg-[#efefef] rounded-full outline-none w-full rounded-bl-lg rounded-br-lg"
              ref={colRef}
            />
          </div>
